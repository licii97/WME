soll die Funktion parseCSV() aufrufen 

die zurückgegebene Datenstruktur in einem HTML <pre> Element anzeigen
			...
			<div id="inhalt">
				...
				<pre>
					<code class="language-php">
						<?php
							echo "Hallo, Welt\n"; //world_data_parser.php -> parseCSV(world_data_v1.csv)
						?>
					  </code>
					</pre>
